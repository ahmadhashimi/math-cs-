...
const PREFACE: string[] = [
  ...
  "Not being good at mathematics kept me out of computer science for a long time. I mean a decade. I decided early that the door was closed to me, and then I lived as though that were a fact about me rather than a decision I had made. Eventually I came back to it. Then I came back again, and again, and every pass through left me better than the one before. That is the part nobody says out loud: returning to something is normal, and needing more than one attempt is not evidence that you are slow. It is just what learning looks like from the inside.",
